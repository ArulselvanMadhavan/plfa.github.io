...
<pre class="Agda">{% raw %}<a id="13306" class="Comment">-- Your code goes here</a>{% endraw %}</pre>


#### Exercise `Stable` (stretch)

Say that a formula is _stable_ if double negation elimination holds for it:
<pre class="Agda">{% raw %}<a id="Stable"></a><a id="13465" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Negation.md %}{% raw %}#13465" class="Function">Stable</a> <a id="13472" class="Symbol">:</a> <a id="13474" class="PrimitiveType">Set</a> <a id="13478" class="Symbol">→</a> <a id="13480" class="PrimitiveType">Set</a>
<a id="13484" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Negation.md %}{% raw %}#13465" class="Function">Stable</a> <a id="13491" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Negation.md %}{% raw %}#13491" class="Bound">A</a> <a id="13493" class="Symbol">=</a> <a id="13495" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Negation.md %}{% raw %}#914" class="Function Operator">¬</a> <a id="13497" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Negation.md %}{% raw %}#914" class="Function Operator">¬</a> <a id="13499" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Negation.md %}{% raw %}#13491" class="Bound">A</a> <a id="13501" class="Symbol">→</a> <a id="13503" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/Negation.md %}{% raw %}#13491" class="Bound">A</a>{% endraw %}</pre>
Show that any negated formula is stable, and that the conjunction
of two stable formulas is stable.

<pre class="Agda">{% raw %}<a id="13630" class="Comment">-- Your code goes here</a>{% endraw %}</pre>

## Standard Prelude

Definitions similar to those in this chapter can be found in the standard library:
<pre class="Agda">{% raw %}<a id="13782" class="Keyword">import</a> <a id="13789" href="https://agda.github.io/agda-stdlib/Relation.Nullary.html" class="Module">Relation.Nullary</a> <a id="13806" class="Keyword">using</a> <a id="13812" class="Symbol">(</a><a id="13813" href="https://agda.github.io/agda-stdlib/Relation.Nullary.html#464" class="Function Operator">¬_</a><a id="13815" class="Symbol">)</a>
<a id="13817" class="Keyword">import</a> <a id="13824" href="https://agda.github.io/agda-stdlib/Relation.Nullary.Negation.html" class="Module">Relation.Nullary.Negation</a> <a id="13850" class="Keyword">using</a> <a id="13856" class="Symbol">(</a><a id="13857" href="https://agda.github.io/agda-stdlib/Relation.Nullary.Negation.html#688" class="Function">contraposition</a><a id="13871" class="Symbol">)</a>{% endraw %}</pre>
